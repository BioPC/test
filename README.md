...
>
> If legacy YAML/runtime helpers remain after cleanup, remove their YAML/package definition and use **Restart Home Assistant** on the migration screen. HPVC rescans automatically during startup; **Refresh detection** remains available only as a manual recheck.
